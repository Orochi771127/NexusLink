...
- `src/three/` — 經 scene profile 明示核准的即時 3D 呈現、GLB lifecycle 與 world-to-screen 投影。只讀 engine snapshot；禁止持有 gameplay／collision／outcome／save／relationship／Growth／Safety authority，且不得直接操作 DOM UI。
