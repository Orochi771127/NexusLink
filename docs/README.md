...
- **架構 / 檔案治理**：`architecture/FILE_OWNERSHIP.md`、`architecture/ADR-002-MULTI_COMPANION_RELATIONSHIP_AUTHORITY.md`（Pack 2）、`architecture/ADR-003-MEMORY_SINGLE_TRUTH_PROJECTION.md`（Pack 3）、`architecture/RAPHAEL_CORE_JS_V1.md`、`architecture/COMPANION_PREFERENCE_PERSISTENCE_V1.md`、`architecture/RAPHAEL_GATEWAY_SERVER_V1.md`、`architecture/PACKAGING_ROADMAP.md`、`architecture/RUNTIME_MAP.md`（⚠️ NEEDS UPDATE：對照現行程式驗證舊 storage/runtime 陳述）。
