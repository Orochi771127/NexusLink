...
- **產品／架構審查（Proposed，未升格 Canon）**：`audits/PRODUCT_TENSION_AND_STATE_AUTHORITY_REVIEW.md`、`audits/FIRST_SESSION_MOTIVATION_REVIEW.md`、`strategy/NEXUS_LINK_REPAIR_SEQUENCE.md`、`strategy/PACK2_RELATIONSHIP_AUTHORITY_MIGRATION.md`、`strategy/PACK5_TERMINOLOGY_GLOSSARY.md`。
