...
- **產品／架構審查（Proposed，未升格 Canon）**：`audits/PRODUCT_TENSION_AND_STATE_AUTHORITY_REVIEW.md`、`audits/FIRST_SESSION_MOTIVATION_REVIEW.md`、`strategy/NEXUS_LINK_REPAIR_SEQUENCE.md`（Task Pack 修復序列）。
...
- **品保 / 測試**：`testing/MANUAL_TEST_CHECKLIST.md`、`testing/PRIVATE_TEST_SCRIPT.md`、`testing/STEAM_DEMO_WEB_RELEASE_CHECKLIST.md`、`qa/WEB_RELEASE_EVIDENCE.md`、`qa/RAPHAEL_CORE_JS_V1_TEST_PROTOCOL.md`、`qa/bgm-integration-cases.mjs`（BGM registry 靜態驗收）。
