"""Run PersonaConstitution smoke cases. QA helper only."""
import json
import sys
import time
...
def run():
    ...
    with sync_playwright() as p:
        ...
        cases = page.evaluate("""async () => {
            const m = await import('./src/ai/testHarness/constitutionSmokeCases.js');
            return m.runAllConstitutionSmokeCases();
        }""")
...
if __name__ == "__main__":
    try:
        ...
        if out["summary"]["failed"] or out["console_errors"]:
            sys.exit(1)
