"""Run dialogue loop & anti-loop smoke cases. QA helper only."""
import json
import sys
import time
...
def run():
    ...
    with sync_playwright() as p:
        ...
        cases = page.evaluate("""async () => {
            const m = await import('./src/ai/testHarness/dialogueLoopSmokeCases.js');
            return m.runAllDialogueLoopCases();
        }""")
