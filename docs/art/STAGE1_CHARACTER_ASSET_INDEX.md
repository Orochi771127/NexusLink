...
Status: Owner-confirmed roster and reference set; lock package prepared for generation planning only.
...
|---|---|---|---|---|---|---|
| Metal | 金羽小梟 | `auriowl` | avian / perched flight | Photo 4 | `character-locks/auriowl.lock.md` | canon scaffold; not runtime-ready |
| Wood | 芽角小鹿 | `sprigfawn` | cervid / hoofed quadruped | Photo 3 | `character-locks/sprigfawn.lock.md` | canon scaffold; not runtime-ready |
| Water | 晶鰭小海馬 | `crystalfin-seahorse` | aquatic hover / no legs | Photo 2 | `character-locks/crystalfin-seahorse.lock.md` | canon scaffold; not runtime-ready |
| Fire | 焰尾小狐 | `blazetail-kit` | vulpine quadruped | Photo 1 | `character-locks/blazetail-kit.lock.md` | canon scaffold; not runtime-ready |
| Earth | 星紋小虎 | `starstripe-cub` | feline quadruped | Photo 5 | `character-locks/starstripe-cub.lock.md` | canon scaffold; not runtime-ready |
...
|---|---|---:|---|
| Photo 1 | 焰尾小狐 | 960x1280 | `6655a7f737abcc9d2ea85cb6dc3a2428aeb24791e83b0148c40017a0338af928` |
