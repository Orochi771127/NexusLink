...
- Location: `output/character-pilots/wavecub/<action>/`
...
WaveCub is mechanically and visually ready for Owner review as a complete staging catalog. It is not approved for `assets/**`, registry, or runtime promotion by this QC record.
