...
export const GAMEPLAY_VISUAL_PROFILE_VERSION = 2;

export const GAMEPLAY_SKIN_ASSET_ROOT = "assets/gameplay/GameplaySkins_r3";
...
const ORBIT_PROFILES = Object.freeze({
  moonlake: Object.freeze({
    ...
    assetSlots: Object.freeze({
      foundation: `${GAMEPLAY_SKIN_ASSET_ROOT}/orbit_moonlake_foundation.png`,
      foundationWidth: 852,
      foundationHeight: 1846,
      foundationFocalY: 0.58,
      materialAtlas: null,
      foreground: null
    })
  }),
  plains: Object.freeze({
    ...
    assetSlots: Object.freeze({
      foundation: null,
      foundationWidth: null,
      foundationHeight: null,
      foundationFocalY: 0.5,
      materialAtlas: null,
      foreground: null
    })
  })
...
const EXPEDITION_PROFILES = Object.freeze({
  plains_windrest: Object.freeze({
    ...
    assetSlots: Object.freeze({
      foundation: `${GAMEPLAY_SKIN_ASSET_ROOT}/expedition_windrest_foundation.png`,
      foundationWidth: 853,
      foundationHeight: 1844,
      foundationFocalY: 0.54,
      decorAtlas: null,
      foreground: null
    })
  }),
