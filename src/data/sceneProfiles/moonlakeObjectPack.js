...
export const moonlakeObjectPack = Object.freeze({
  ...
  placementGrid: GRID,
  slots: Object.freeze([
    slot({ id: "moonlake-crescent-shrine", cell: { column: 3, row: 7 }, offsetPx: { x: 20, y: -60 }, depthBand: "far", renderLayer: "farStructures", allowedKinds: ["shrine"], maxDisplaySize: { width: 130, height: 180 }, waterRule: "island-ground-only", companionClearance: 360, uiClearance: "hud-and-bottom-nav", shadowFootprint: { width: 76, height: 24, opacity: 0.2 }, dayNightPolicy: "shared-base-plus-emissive", stateKey: "moonlake.shrineState" }),
    slot({ id: "moonlake-far-beacon", cell: { column: 7, row: 5 }, offsetPx: { x: 29, y: -8 }, depthBand: "far", renderLayer: "farStructures", allowedKinds: ["beacon"], maxDisplaySize: { width: 86, height: 154 }, waterRule: "island-ground-only", companionClearance: 420, uiClearance: "hud-and-dialogue", shadowFootprint: { width: 52, height: 17, opacity: 0.18 }, dayNightPolicy: "shared-base-plus-emissive" }),
    slot({ id: "moonlake-far-tent", cell: { column: 8, row: 7 }, offsetPx: { x: 1, y: -40 }, depthBand: "far", renderLayer: "farStructures", allowedKinds: ["tent"], maxDisplaySize: { width: 128, height: 105 }, waterRule: "island-ground-only", companionClearance: 360, uiClearance: "hud-and-dialogue", shadowFootprint: { width: 82, height: 21, opacity: 0.18 }, dayNightPolicy: "shared-base-plus-emissive" }),
    slot({ id: "moonlake-main-beacon", cell: { column: 5, row: 7 }, offsetPx: { x: 34, y: 5 }, depthBand: "mid", renderLayer: "midStructures", allowedKinds: ["beacon"], maxDisplaySize: { width: 120, height: 235 }, waterRule: "island-ground-only", companionClearance: 300, uiClearance: "dialogue-and-companion", shadowFootprint: { width: 74, height: 24, opacity: 0.22 }, dayNightPolicy: "shared-base-plus-emissive", stateKey: "moonlake.mainBeaconState" }),
    slot({ id: "moonlake-mid-left-tent", cell: { column: 3, row: 9 }, offsetPx: { x: 32, y: -27 }, depthBand: "mid", renderLayer: "midStructures", allowedKinds: ["tent"], maxDisplaySize: { width: 166, height: 138 }, waterRule: "island-ground-only", companionClearance: 270, uiClearance: "dialogue-and-companion", shadowFootprint: { width: 104, height: 27, opacity: 0.22 }, dayNightPolicy: "shared-base-plus-emissive" }),
    slot({ id: "moonlake-mid-right-tent", cell: { column: 8, row: 9 }, offsetPx: { x: -39, y: -27 }, depthBand: "mid", renderLayer: "midStructures", allowedKinds: ["tent"], maxDisplaySize: { width: 166, height: 138 }, waterRule: "island-ground-only", companionClearance: 270, uiClearance: "dialogue-and-companion", shadowFootprint: { width: 104, height: 27, opacity: 0.22 }, dayNightPolicy: "shared-base-plus-emissive" }),
    slot({ id: "moonlake-near-left-tent", cell: { column: 2, row: 12 }, offsetPx: { x: -36, y: 30 }, depthBand: "near", renderLayer: "nearStructures", allowedKinds: ["tent"], maxDisplaySize: { width: 246, height: 203 }, waterRule: "shore-ground-only", companionClearance: 190, uiClearance: "companion-and-soul-talk", shadowFootprint: { width: 154, height: 40, opacity: 0.26 }, dayNightPolicy: "shared-base-plus-emissive" }),
    slot({ id: "moonlake-near-right-tent", cell: { column: 10, row: 12 }, offsetPx: { x: 3, y: 17 }, depthBand: "near", renderLayer: "nearStructures", allowedKinds: ["tent"], maxDisplaySize: { width: 246, height: 203 }, waterRule: "shore-ground-only", companionClearance: 190, uiClearance: "companion-and-soul-talk", shadowFootprint: { width: 154, height: 40, opacity: 0.26 }, dayNightPolicy: "shared-base-plus-emissive" })
  ]),
