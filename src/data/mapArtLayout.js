...
export const MOONLAKE_NODE_LAYOUT = Object.freeze({
  ...
  plains_windrest: { x: 86, y: 36, tone: "calm", glyph: "⌁", vignette: "./assets/maps/moonlake/route/nodes/windrest-meadow-v1.jpg" },
  plains_rift: { x: 50, y: 7, tone: "danger", glyph: "×", vignette: "./assets/maps/moonlake/route/nodes/lonesong-rift-v1.jpg" },
