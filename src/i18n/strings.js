...
export const STRINGS = {
  ...
  "growth.formal.title": { tc: "夥伴的邀請", sc: "伙伴的邀请", en: "Its invitation", jp: "この子からの誘い" },
  "growth.formal.canInvite": { tc: "牠靠近你，想一起走進下一段。這不是升級按鈕，牠也可以改天再說。", sc: "牠靠近你，想一起走进下一段。这不是升级按钮，牠也可以改天再说。", en: "It comes closer, wanting to walk the next stretch together. This is not an upgrade button; it may also wait.", jp: "次の段階へ一緒に進みたいと、近づいてくる。強化ボタンではない。改める日でもいい。" },
  "growth.formal.open": { tc: "這份邀請還在。你可以接住，也可以先停在這裡。", sc: "这份邀请还在。你可以接住，也可以先停在这里。", en: "The invitation is still here. You may receive it, or stop here for now.", jp: "この誘いはまだここにある。受けても、今日は止まってもいい。" },
  "growth.formal.rewritePending": { tc: "牠想用自己的方式走完這一段。只有你明示接受後，才會一起踏出去。", sc: "牠想用自己的方式走完这一段。只有你明示接受后，才会一起踏出去。", en: "It wants to walk this stretch in its own way. You only step forward together after you explicitly accept.", jp: "この子は自分のやり方でこの一段を歩きたい。あなたが明確に受け入れてから、一緒に踏み出す。" },
  "growth.formal.complete": { tc: "目前沒有下一段邀請；已留下的共同痕跡仍會保留。", sc: "目前没有下一段邀请；已经留下的共同痕迹仍会保留。", en: "There is no further invitation now. The traces already shared will remain.", jp: "いま次の誘いはない。すでに共有した痕跡は残る。" },
  "growth.formal.notNow": { tc: "牠現在沒有把這一步走完。沒有懲罰，也不會過期。", sc: "牠现在没有把这一步走完。没有惩罚，也不会过期。", en: "It does not take this step now. There is no penalty, and nothing expires.", jp: "いまはこの一歩を終えない。罰もなく、期限もない。" },
  "growth.formal.actionsAria": { tc: "回應夥伴的正式邀請", sc: "回应伙伴的正式邀请", en: "Respond to the companion's formal invitation", jp: "正式な誘いへの応答" },
  "growth.formal.offer.label": { tc: "聽聽牠的邀請", sc: "听听牠的邀请", en: "Hear its invitation", jp: "誘いを聴く" },
  "growth.formal.offer.copy": { tc: "讓牠把這一步說出來。還不是換形，也可以先停住。", sc: "让牠把这一步说出来。还不是换形，也可以先停住。", en: "Let it speak this step. This is not a form change, and you may still stop.", jp: "この一歩を言葉にしてもらう。姿を変えることではない。止まってもいい。" },
  "growth.formal.accept.label": { tc: "接住這份邀請", sc: "接住这份邀请", en: "Receive this invitation", jp: "この誘いを受け取る" },
  "growth.formal.accept.copy": { tc: "一起走進下一階。先安穩存下來，再讓畫面跟上。", sc: "一起走进下一阶。先安稳存下来，再让画面跟上。", en: "Walk the next stage together. Save it safely first, then let the scene follow.", jp: "次の段階へ一緒に進む。まず静かに残し、画面はその後。" },
  "growth.formal.defer.label": { tc: "今天先停在這裡", sc: "今天先停在这里", en: "Stop here today", jp: "今日はここで止める" },
  "growth.formal.defer.copy": { tc: "不扣分、不倒數。之後牠願意時，還可以再邀請。", sc: "不扣分、不倒数。之后牠愿意时，还可以再邀请。", en: "No penalty and no countdown. It may invite again when willing.", jp: "減点もカウントダウンもない。また誘いたくなった時に、もう一度誘える。" },
  "growth.formal.rewriteAccept.label": { tc: "照牠的方式繼續", sc: "照牠的方式继续", en: "Follow its revision", jp: "この子のやり方で続ける" },
  "growth.formal.rewriteAccept.copy": { tc: "接受牠改過的節奏，再一起踏出下一步。", sc: "接受牠改过的节奏，再一起踏出下一步。", en: "Accept its changed rhythm, then take the next step together.", jp: "変えられたリズムを受け入れてから、次の一歩を一緒に出す。" },
  "growth.formal.status.offered": { tc: "牠把邀請放下了。你可以接住，也可以先停。", sc: "牠把邀请放下了。你可以接住，也可以先停。", en: "It has set the invitation down. You may receive it, or wait.", jp: "誘いを置いた。受けても、待ってもいい。" },
  "growth.formal.status.deferred": { tc: "你們先停在這裡。沒有錯過，也不會被催促。", sc: "你们先停在这里。没有错过，也不会被催促。", en: "You stop here for now. Nothing was missed, and nothing hurries you.", jp: "いまはここで止める。逃したものはなく、急かされることもない。" },
  "growth.formal.status.rewritePending": { tc: "牠想改寫這段邀請。只有你再答應一次，才會一起走。", sc: "牠想改写这段邀请。只有你再答应一次，才会一起走。", en: "It wants to revise this invitation. You walk together only after you agree again.", jp: "この誘いを書き換えたい。もう一度承諾してから、一緒に進む。" },
  "growth.formal.status.accepted": { tc: "這一步已經安穩留下。畫面可以稍後跟上，關係不會因此被催促。", sc: "这一步已经安稳留下。画面可以稍后跟上，关系不会因此被催促。", en: "This step is safely kept. The scene may follow later; the relationship is not rushed.", jp: "この一歩は静かに残った。画面は後からでもいい。関係は急かされない。" },
  "growth.formal.status.alreadyAccepted": { tc: "這份邀請已經接過了。不會再升一階，也不會再催一次。", sc: "这份邀请已经接过了。不会再升一阶，也不会再催一次。", en: "This invitation was already received. It will not rise another stage, and it will not ask again.", jp: "この誘いはすでに受け取っている。もう一段進むことも、重ねて急かすこともない。" },
