...
export const STRINGS = {
  ...
  // ---- Growth page content ----
  "growth.session.kicker": { tc: "心相試作 · 當下觀察", sc: "心相试作 · 当下观察", en: "Heart Phase · This moment", jp: "心相プロトタイプ・今の観察" },
  "growth.session.companionFallback": { tc: "夥伴", sc: "伙伴", en: "Companion", jp: "パートナー" },
  "growth.session.phase.safety_pause.label": { tc: "安全停泊", sc: "安全停泊", en: "Safe harbor", jp: "安全な停泊" },
  "growth.session.phase.safety_pause.copy": { tc: "此刻不進行養成判定；先讓安全停泊保持完整。", sc: "此刻不进行养成判定；先让安全停泊保持完整。", en: "Growth pauses here so safe harbor can remain whole.", jp: "いまは成長を判定せず、安全な停泊をそのまま保つ。" },
  ...
  "growth.session.observedNote": { tc: "是質性觀察，不是進度；離開也不會失去任何東西。", sc: "是质性观察，不是进度；离开也不会失去任何东西。", en: "A qualitative observation, not progress. Leaving loses nothing.", jp: "進捗ではなく質的な観察。離れても何も失わない。" },
  ...
  "growth.session.prototype.title": { tc: "遠征碎晶與共鳴製作", sc: "远征碎晶与共鸣制作", en: "Expedition shards and resonance crafting", jp: "遠征の欠片と共鳴制作" },
  "growth.session.prototype.badge": { tc: "Prototype · 不影響心相", sc: "Prototype · 不影响心相", en: "Prototype · No Heart Phase effect", jp: "Prototype・心相に影響なし" },
  "growth.session.prototype.copy": { tc: "這是獨立試作，不計入心相、正式階段或最佳路線。", sc: "这是独立试作，不计入心相、正式阶段或最佳路线。", en: "This separate prototype does not count toward Heart Phase, formal stages, or an optimal route.", jp: "独立した試作であり、心相・正式段階・最適ルートには数えない。" },
  "growth.session.prototype.shardsAria": { tc: "遠征碎晶庫存", sc: "远征碎晶库存", en: "Expedition shard inventory", jp: "遠征の欠片の所持数" },
  "growth.session.prototype.craftAria": { tc: "試作共鳴製作", sc: "试作共鸣制作", en: "Prototype resonance crafting", jp: "試作の共鳴制作" },
  "growth.session.prototype.locked": { tc: "碎晶不足；這不影響心相養成。", sc: "碎晶不足；这不影响心相养成。", en: "Not enough shards; this does not affect Heart Phase growth.", jp: "欠片が足りない。心相の成長には影響しない。" },
