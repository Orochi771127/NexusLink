...
export const STRINGS = {
  ...
  "growth.session.observedNote": { tc: "是質性觀察，不是進度；這一幕結束就淡去，關係不會因此減少。", sc: "是质性观察，不是进度；这一幕结束就淡去，关系不会因此减少。", en: "A qualitative observation, not progress. It fades with this moment and never costs the relationship.", jp: "進捗ではない質的な観察。この場面とともに消えても、関係は減らない。" },
