...
const LINES = Object.freeze({
  ...
  explore: [
    "牠朝湖的方向停了一會兒，好像對外面有點好奇。",
    "牠望向遠處的星林，像是想去走走。",
    // 對岸在 MOONLAKE_WORLD_EDGES 上是孤立節點——橋走到底也過不去。
    // 這兩句把「走不到」寫成牠自己的心事，不是上鎖的內容：留一個問題，不留一個任務。
    "牠望著湖的另一邊，看了很久。那裡有什麼，牠沒有說。",
    "牠朝對岸看了一眼，又收回目光。像是記得什麼，又像是還不打算說。"
  ],
  stillness: [
    "牠很安穩地待著。此刻，什麼都不做也很好。",
    "夜很靜，牠就靠在你旁邊。這樣就夠了。"
