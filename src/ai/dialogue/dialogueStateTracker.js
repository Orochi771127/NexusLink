...
function hasExplicitTopicShift(inputText) {
  ...
  if (
    /洗澡|洗完澡|剛起床|刚起床|塞車|塞车|下雨|鞋子|衣服洗|房間|房间|肚子餓|肚子饿|飯糰|饭团|熱茶|热茶|無聊|无聊|週末|周末|假日|追劇|打遊戲|盆栽|睡不著|鬧鐘|包裹|超市|電量|海邊|宵夜|約聚餐|同事聊天|好熱|好冷|忘了帶傘|理髮|換季|牙醫|健檢|健康檢查|捷運|悠遊卡|鄰居|裝修|演唱會|展覽|偶像|新歌|煮焦|外送|家人|媽媽|罪惡感|天氣 App|天氣App|普通的一天|平平淡淡|當眾損|功勞|離職|曖昧|已讀不回|分手|告白|想開一點|同學.*比較好|找人聊聊|就是悶/.test(
      text
    )
  ) {
    return true;
