...
export function classifyTopic(inputText = "", entities = [], analysis = {}) {
  ...
  if (/下班|放空|腦袋空|腦袋空空|吃完飯|吃飽|想躺|躺一下|懶懶|懶得動|剛醒|睡醒|日常|今天普通|追劇|追剧|耍廢|耍废|滑手機|滑手机|發呆|发呆|無聊|无聊|週末|周末|假日|放假|收假|下雨|天氣|天气|好熱|好热|好冷|逛街|散步|喝咖啡|泡茶|躺平|捷運|地鐵|地铁|公車|公交|坐過站|坐过站|晚餐|午餐|早餐|便當|便当|青菜|吃了|吃到|早點睡|早点睡|想來找你講|想来找你讲|想聊兩句|想聊两句|沒發生什麼|没发生什么|不知道要幹嘛|不知道要干嘛|有夠荒謬|有够荒谬/.test(text)) {
